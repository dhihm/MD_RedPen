...
fn mouse_drag_selects_exact_cjk_graphemes() -> Result<(), Box<dyn std::error::Error>> {
    ...
    app.handle_mouse(MouseEventKind::Down(MouseButton::Left), start);
    app.handle_mouse(MouseEventKind::Drag(MouseButton::Left), end);
    app.handle_mouse(MouseEventKind::Up(MouseButton::Left), end);
